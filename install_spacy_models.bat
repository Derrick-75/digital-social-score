@echo off
REM Script d'installation des modèles spaCy pour Windows

echo 🚀 Installation des modèles spaCy pour Digital Social Score

REM Modèles anglais (pour dataset Toxic Comment)
echo 📦 Installation du modèle anglais large...
python -m spacy download en_core_web_lg

REM Modèle français (pour commentaires français)  
echo 📦 Installation du modèle français large...
python -m spacy download fr_core_news_lg

REM Modèle multilingue (backup)
